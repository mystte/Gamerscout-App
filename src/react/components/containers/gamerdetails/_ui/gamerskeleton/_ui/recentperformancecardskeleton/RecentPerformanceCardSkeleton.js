  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={styles.dropdown1}><DropDownSkeleton /></div>
        <div style={styles.dropdown2}><DropDownSkeleton /></div>
      </div>
      <div style={styles.bottomContainer}>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.right}>
            <div style={styles.topRect}><Rectangle width={120} height={15} /></div>
            <Rectangle width={120} height={15} />
          </div>
        </div>
      </div>
