...
import ReviewRecord, {
  REVIEW_TYPE,
} from '../../../../../../../datamanager/models/ReviewRecord';
...
class Review extends PureComponent {
  ...
  renderAttributesIcons = () =>
    this.props.reviewRecord.attributes.map((attribute, idx) => {
      ...
      return (
        <div style={attributeIconStyle} key={`attribute-${attribute.name}`}>
          <SVGIcon
            width={28}
            height={28}
  ...
  render() {
    ...
    const reviewTypeStyle =
      this.props.reviewRecord.type === REVIEW_TYPE.APPROVAL
        ? {
            ...styles.reviewType,
            ...styles.approval,
          }
      ...
      <div style={styles.container}>
        <div style={styles.top}>
          <div style={styles.header}>
            ...
            <div style={styles.gamerContainer}>
              <span style={styles.name}>
                {this.props.reviewRecord.reviewerName}
              </span>
          ...
          <div style={styles.commentContainer}>
            {this.props.reviewRecord.comment}
          </div>
        </div>
