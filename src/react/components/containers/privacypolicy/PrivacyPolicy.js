    ...
    <div style={styles.container}>
      ...
      <div style={styles.textBloc}>
        <p>
          ...
          Privacy applies to gamerscout.com and Gamerscout and governs data
          collection and usage. For the purposes of this Privacy Policy, unless
          otherwise noted, all references to Gamerscout include gamerscout.com.
          The Gamerscout website is a The purpose of gamerscout.com is for
          gamers to find, connect with, and review peers so that they may have
          an improved social gaming experience on major gaming platforms. site.
          By using the Gamerscout website, you consent to the data practices
          described in this statement.
        </p>
        <p>Collection of your Personal Information</p>
        <p>
          In order to better provide you with products and services offered on
          our Site, Gamerscout may collect personally identifiable information,
          such as your:
        </p>
        <p>* E-mail Address</p>
        <p>
          ...
          Gamerscout's public message boards, this information may be collected
          and used by others.
        </p>
        <p>
        ...
        <p>
          Gamerscout collects and uses your personal information to operate its
          website(s) and deliver the services you have requested.
        </p>
        <p>
          Gamerscout may also use your personally identifiable information to
          inform you of other products or services available from Gamerscout and
          its affiliates.
        </p>
        <p>Sharing Information with Third Parties</p>
        <p>
          Gamerscout does not sell, rent or lease its customer lists to third
          parties.
        </p>
        <p>
          Gamerscout may, from time to time, contact you on behalf of external
          ...
          transferred to the third party. Gamerscout may share data with trusted
          ...
          except to provide these services to Gamerscout, and they are required
          to maintain the confidentiality of your information.
        </p>
        <p>
          Gamerscout may disclose your personal information, without notice, if
          ...
          legal process served on Gamerscout or the site; (b) protect and defend
          the rights or property of Gamerscout; and/or (c) act under exigent
          circumstances to protect the personal safety of users of Gamerscout,
          or the public.
        </p>
        <p>Tracking User Behavior</p>
        <p>
          Gamerscout may keep track of the websites and pages our users visit
          within Gamerscout, in order to determine what Gamerscout services are
          the most popular. This data is used to deliver customized content and
          advertising within Gamerscout to customers whose behavior indicates
          that they are interested in a particular subject area.
        </p>
        <p>Automatically Collected Information</p>
        <p>
          Information about your computer hardware and software may be
          automatically collected by Gamerscout. This information can include:
          ...
          provide general statistics regarding use of the Gamerscout website.
        </p>
        <p>Use of Cookies</p>
        <p>
          The Gamerscout website may use "cookies" to help you personalize your
        ...
        <p>
          ...
          personalize Gamerscout pages, or register with Gamerscout site or
          services, a cookie helps Gamerscout to recall your specific
          ...
          shipping addresses, and so on. When you return to the same Gamerscout
          website, the information you previously provided can be retrieved, so
          you can easily use the Gamerscout features that you customized.
        </p>
        <p>
          ...
          features of the Gamerscout services or websites you visit.
        </p>
        <p>Links</p>
        <p>
        ...
        <p>
          Gamerscout secures your personal information from unauthorized access,
          use, or disclosure. Gamerscout uses the following methods for this
          purpose:
        </p>
        <p>-SSL Protocol</p>
        <p>
        ...
        <p>
          Gamerscout does not knowingly collect personally identifiable
        ...
        <p>
          From time to time, Gamerscout may contact you via email for the
          ...
          an email from Gamerscout or click on a link therein.
        </p>
        <p>
          If you would like to stop receiving marketing or promotional
          communications via email from Gamerscout, you may opt out of such
        ...
        <p>
          Gamerscout reserves the right to change this Privacy Policy from time
        ...
        <p>
          Gamerscout welcomes your questions or comments regarding this
          Statement of Privacy. If you believe that Gamerscout has not adhered
          to this Statement, please contact Gamerscout at:
        </p>
