...
import { getPrivacyPolicyUrl } from '../../../config/routes';
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.tabContainer}>
        ...
        <div style={styles.selected}>{labels.terms}</div>
      </div>
      <div style={styles.textBloc}>
        <p>Terms and Conditions</p>
        <p>Agreement between User and gamerscout.com</p>
        <p>
          Welcome to gamerscout.com. The gamerscout.com website (the "Site") is
          comprised of various web pages operated by Gamerscout. gamerscout.com
          ...
          Your use of gamerscout.com constitutes your agreement to all such
          Terms. Please read these terms carefully, and keep a copy of them for
          your reference.
        </p>
        <p>gamerscout.com is a Social Networking Site.</p>
        <p>
          The purpose of gamerscout.com is for gamers to find, connect with, and
          review peers so that they may have an improved social gaming
          experience on major gaming platforms.
        </p>
        <p>Privacy</p>
        <p>
          Your use of gamerscout.com is subject to Gamerscout's Privacy Policy.
        ...
        <p>
          Visiting gamerscout.com or sending emails to Gamerscout constitutes
        ...
        <p>
          ...
          entity. You acknowledge that Gamerscout is not responsible for third
          party access to your account that results from theft or
          misappropriation of your account. Gamerscout and its associates
        ...
        <p>
          Gamerscout does not knowingly collect, either online or offline,
          personal information from persons under the age of thirteen. If you
          are under 18, you may use gamerscout.com only with permission of a
          parent or guardian.
        </p>
        <p>Links to Third Party Sites/Third Party Services</p>
        <p>
          gamerscout.com may contain links to other websites ("Linked Sites").
          The Linked Sites are not under the control of Gamerscout and
          Gamerscout is not responsible for the contents of any Linked Site,
          including without limitation any link contained in a Linked Site, or
          any changes or updates to a Linked Site. Gamerscout is providing these
          links to you only as a convenience, and the inclusion of any link does
          not imply endorsement by Gamerscout of the site or any association
          with its operators.
        </p>
        <p>
          Certain services made available via gamerscout.com are delivered by
          third party sites and organizations. By using any product, service or
          functionality originating from the gamerscout.com domain, you hereby
          acknowledge and consent that Gamerscout may share such information and
          data with any third party with whom Gamerscout has a contractual
          relationship to provide the requested product, service or
          functionality on behalf of gamerscout.com users and customers.
        </p>
        <p>No Unlawful or Prohibited Use/Intellectual Property</p>
        <p>
          You are granted a non-exclusive, non-transferable, revocable license
          to access and use gamerscout.com strictly in accordance with these
          terms of use. As a condition of your use of the Site, you warrant to
          Gamerscout that you will not use the Site for any purpose that is
        ...
        <p>
          ...
          used on the Site, is the property of Gamerscout or its suppliers and
        ...
        <p>
          ...
          Gamerscout content is not for resale. Your use of the Site does not
          ...
          content without the express written permission of Gamerscout and the
          ...
          express or implied, to the intellectual property of Gamerscout or our
          licensors except as expressly authorized by these Terms.  You will
          not use the Site as part of any effort to compete with us. 
        </p>
        <p>
          You agree that you will not publicly disclose of any Personal
          Identifiable Information (PII), of any individual, including, but not
          limited to, names, addresses, and contact information. You will not
          use any information obtained by the Site in an attempt to harass,
          abuse, or harm another user, employee, or person. You will
          not threaten, intimidate, or harass any Gamerscout employees.
        </p>
        <p>
          You will not use the Site to advertise, offer, or sell goods or
          services without written permission from us. You agree that our
          support services are to be used solely for support and will not submit
          false reports of misconduct, misuse, or abuse, or otherwise make
          improper use of our support systems or services. You agree to
          not disparage, tarnish, or otherwise harm, in our opinion, us and/or
          the Site.
        </p>
        ...
        <p>
          Gamerscout has no obligation to monitor the Communication Services.
          However, Gamerscout reserves the right to review materials posted to a
          Communication Service and to remove any materials in its sole
          discretion. Gamerscout reserves the right to terminate your access to
          any or all of the Communication Services at any time without notice
          for any reason whatsoever.
        </p>
        <p>
          Gamerscout reserves the right at all times to disclose any information
          ...
          information or materials, in whole or in part, in Gamerscout's sole
          discretion.
        </p>
        <p>
          ...
          Service. Gamerscout does not control or endorse the content, messages
          or information found in any Communication Service and, therefore,
          Gamerscout specifically disclaims any liability with regard to the
          ...
          authorized Gamerscout spokespersons, and their views do not
          necessarily reflect those of Gamerscout.
        </p>
        <p>
        ...
        <p>
          Materials Provided to gamerscout.com or Posted on Any Gamerscout Web
          Page
        </p>
        <p>
          Gamerscout does not claim ownership of the materials you provide to
          gamerscout.com (including feedback and suggestions) or post, upload,
          input or submit to any Gamerscout Site or our associated services
          (collectively "Submissions"). However, by posting, uploading,
          inputting, providing or submitting your Submission you are granting
          Gamerscout, our affiliated companies and necessary sublicensees
        ...
        <p>
          ...
          Submission, as provided herein. Gamerscout is under no obligation to
          post or use any Submission you may provide and may remove any
          Submission at any time in Gamerscout's sole discretion.
        </p>
        <p>
        ...
        <p>
          You will be able to connect your Gamerscout account to third party
          accounts. By connecting your Gamerscout account to your third party
        ...
        <p>
          The Service is controlled, operated and administered by Gamerscout
          ...
          local laws. You agree that you will not use the Gamerscout Content
          accessed through gamerscout.com in any country or in any manner
          prohibited by any applicable laws, restrictions or regulations.
        </p>
        <p>Indemnification</p>
        <p>
          You agree to indemnify, defend and hold harmless Gamerscout, its
          ...
          rules or regulations. Gamerscout reserves the right, at its own cost,
          ...
          cooperate with Gamerscout in asserting any available defenses.
        </p>
        <p>Arbitration</p>
        <p>
        ...
        <p>
          ...
          Further, unless both you and Gamerscout agree otherwise, the
        ...
        <p>
          ...
          GAMERSCOUT AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES
          IN THE SITE AT ANY TIME.
        </p>
        <p>
          GAMERSCOUT AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
          ...
          CONDITION OF ANY KIND. GAMERSCOUT AND/OR ITS SUPPLIERS HEREBY DISCLAIM
        ...
        <p>
          ...
          GAMERSCOUT AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT,
          ...
          STRICT LIABILITY OR OTHERWISE, EVEN IF GAMERSCOUT OR ANY OF ITS
        ...
        <p>
          Gamerscout reserves the right, in its sole discretion, to terminate
          ...
          Delaware and you hereby consent to the exclusive jurisdiction and
          venue of courts in Delaware in all disputes arising out of or relating
        ...
        <p>
          ...
          relationship exists between you and Gamerscout as a result of this
          agreement or use of the Site. Gamerscout's performance of this
          agreement is subject to existing laws and legal process, and nothing
          contained in this agreement is in derogation of Gamerscout's right to
          ...
          to or gathered by Gamerscout with respect to such use. If any part of
        ...
        <p>
          ...
          entire agreement between the user and Gamerscout with respect to the
          ...
          Gamerscout with respect to the Site. A printed version of this
        ...
        <p>
          Gamerscout reserves the right, in its sole discretion, to change the
          Terms under which gamerscout.com is offered. The most current version
          of the Terms will supersede all previous versions. Gamerscout
          encourages you to periodically review the Terms to stay informed of
          our updates.
        </p>
        <p>Contact Us</p>
        <p>
          Gamerscout welcomes your questions or comments regarding the Terms:
        </p>
